...
import huynhdat.listener.RequestServletListener;
...
public class MarshallToJavaScript extends HttpServlet {
    private static final Logger log = Logger.getLogger(MarshallToJavaScript.class.getName());
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            TblShoe shoe = shoeService.getById(Integer.parseInt(id));
            dto = ShoeDto.toShoeDto(shoe);
            dto.setId(Integer.parseInt(id));
            String xml = XMLUtils.marshallToString(dto);
            response.getWriter().write(xml);
        } catch (JAXBException ex) {
            log.log(Level.SEVERE, "Marshall to string ajax erorr: " + ex.getMessage());
        }
    }
